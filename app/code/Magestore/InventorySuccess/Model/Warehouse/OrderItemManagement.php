...
class OrderItemManagement implements OrderItemManagementInterface
{
    ...
    /**
     * @var \Magestore\InventorySuccess\Model\ResourceModel\Warehouse\Order\Item\CollectionFactory
     */
    protected $warehouseOrderItemCollectionFactory;  
    
    /**
     * @var \Magestore\InventorySuccess\Model\ResourceModel\Warehouse\OrderItemManagementFactory 
     */
    protected $resourceFactory;
    
    public function __construct(
        \Magestore\InventorySuccess\Model\Warehouse\Order\ItemFactory $warehouseOrderItemFactory,
        \Magestore\InventorySuccess\Model\ResourceModel\Warehouse\Order\Item\CollectionFactory $warehouseOrderItemCollectionFactory,
        \Magestore\InventorySuccess\Model\ResourceModel\Warehouse\OrderItemManagementFactory $resourceFactory
    )
    {
    ...
    {
        $warehouseItem = $this->warehouseOrderItemCollectionFactory->create()
    ...
    {
        $warehouseIds = [];
        $collection = $this->warehouseOrderItemCollectionFactory->create()
