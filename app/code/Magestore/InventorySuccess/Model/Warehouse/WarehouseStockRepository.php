...
class WarehouseStockRepository implements WarehouseStockRepositoryInterface
{
    ...
    /**
     * @var \Magestore\InventorySuccess\Model\ProviderInterface\Warehouse\WarehouseStockRegistryProviderInterface
     */
    protected $warehouseStockRegistryProvider;
    ...
    public function __construct(
        ...
        \Magestore\InventorySuccess\Model\ProviderInterface\Warehouse\WarehouseStockRegistryProviderInterface $warehouseStockRegistryProvider,
    ...
    )
    {
        ...
        $this->warehouseStockRegistryProvider = $warehouseStockRegistryProvider;
    ...
    public function get($warehouseId, $productSku)
    {
        ...
        return $this->warehouseStockRegistryProvider->getWarehouseStock($warehouseId, $productId);
    }
    ...
    public function getList(\Magento\Framework\Api\SearchCriteriaInterface $searchCriteria)
    {
        ...
        $collection = \Magento\Framework\App\ObjectManager::getInstance()->get(
            '\Magestore\InventorySuccess\Model\ResourceModel\Warehouse\Product\Collection'
        );

        $collection->getSelect()->joinLeft(
            ['catalog_product' => $collection->getTable('catalog_product_entity')],
            'main_table.warehouse_product_id = catalog_product.entity_id',
