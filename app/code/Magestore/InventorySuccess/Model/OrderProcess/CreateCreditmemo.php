...
class CreateCreditmemo extends OrderProcess implements CreateCreditmemoInterface
{
    ...
    {   
        ...
        $this->queryProcess->start('creditmemo');
        ...
        $this->queryProcess->process('creditmemo');        
    }
    ...
    {       
        ...
        $this->queryProcess->addQueries($queries, 'creditmemo');         
    ...
    public function canProcessItem($item)
    {
        ...
        /* check added item */
        $warehouseCreditmemoItems = $this->warehouseCreditmemoItemFactory->create()
                                    ->getCollection()
                                    ->addFieldToFilter('item_id', $item->getId());
        
        if($warehouseCreditmemoItems->getSize() > 0) {
            return false;
        }
