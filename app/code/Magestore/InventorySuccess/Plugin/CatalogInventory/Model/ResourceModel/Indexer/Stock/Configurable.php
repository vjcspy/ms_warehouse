...
class Configurable extends \Magestore\InventorySuccess\Plugin\CatalogInventory\Model\ResourceModel\Indexer\Stock\DefaultStock
{
   ...
   /**
    ...
    protected function _getStockStatusSelect($entityIds = null, $usePrimaryTable = false)
    {
        ...
        $select->reset(
            ...
            ['e.entity_id', 'cisi.website_id', 'cisi.stock_id']
        )->joinLeft(
            ...
            ['i' => $idxTable],
            'i.product_id = l.product_id AND cisi.website_id = i.website_id AND cisi.stock_id = i.stock_id',
            []
        )->columns(
