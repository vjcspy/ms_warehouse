...
class General extends \Magestore\InventorySuccess\Ui\DataProvider\TransferStock\Send\Form\Modifier\SendStock
{
    ...
    public function getCurrentTransfer()
    {
        ...
        if ($requestId) {
            ...
            $transferStock = $locator->getSesionByKey("current_send_stock");
        }
    ...
    public function getAttributesMeta()
    {
        ...
        $result['source_warehouse_id']['options'] = $this->_warehouseSource->toOptionArray(TransferPermission::SEND_STOCK_CREATE);
        $result['des_warehouse_id']['componentType'] = Field::NAME;
        $result['des_warehouse_id']['options'] = $this->_warehouseSource->toOptionArray(TransferPermission::ALL_WAREHOUSE_SEND_REQUEST);
