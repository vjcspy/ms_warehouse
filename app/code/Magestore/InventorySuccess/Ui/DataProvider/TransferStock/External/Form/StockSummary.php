...
class StockSummary extends AbstractDataProvider
{
    ...
    public function prepareCollection()
    {
        ...
        if($transferstock_id)
        {
            ...
            if($transferstock->getType()==ModelTransferStock::TYPE_FROM_EXTERNAL){
                $warehouse_id = $transferstock->getDesWarehouseId();
            }
            else{
                $warehouse_id = $transferstock->getSourceWarehouseId();
            }
            $collection = $this->collection->getTransferStockProduct($transferstock_id, $warehouse_id);
